...
class Link_Analyzer_Export
{
    ...
    public function export_to_csv()
    {
        ...
        header('Content-Disposition: attachment; filename=link-analyzer-report-' . date('Y-m-d-H-i-s') . '.csv');
    ...
    private function generate_pdf_html($results, $stats)
    {
        ...
        <head>
            <meta charset="UTF-8">
            <title>Link Analyzer Scan Report</title>
            <style>
                body {
                ...
                .header {
                    background: linear-gradient(135deg, #165d96 0%, #0f3e66 100%);
                    color: white;
                    padding: 30px;
                    border-radius: 8px;
                    margin-bottom: 30px;
        ...
        <body>
            <div class="header">
                <h1>🔗 Link Analyzer Scan Report</h1>
            ...
            <div class="footer">
                <p>Link Analyzer - Professional Broken Link Scanner for WordPress</p>
